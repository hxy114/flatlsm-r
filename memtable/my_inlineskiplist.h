...
public:
    ...
    // skiplist object.
    explicit MyInlineSkipList(Comparator cmp, Allocator* allocator, NvmArena* nvm_allocator,
                            int32_t max_height = 12,
                            int32_t branching_factor = 4);
    // No copying allowed
    MyInlineSkipList(const MyInlineSkipList&) = delete;
    MyInlineSkipList& operator=(const MyInlineSkipList&) = delete;
    ...
    public:
        ...
        explicit Iterator(const MyInlineSkipList* list);

        // Change the underlying skiplist used for this iterator
        // This enables us not changing the iterator without deallocating
        // an old one and then allocating a new one
        void SetList(const MyInlineSkipList* list);
...
template <class Comparator>
struct MyInlineSkipList<Comparator>::Splice {
...
template <class Comparator>
struct MyInlineSkipList<Comparator>::Node {
    ...
    const char* Key() const {
      //return reinterpret_cast<char*>(*reinterpret_cast<uint64_t *>(next_[1]));
      return reinterpret_cast<const char*>(next_[1].load());
    }
    const char* Key1() const { return reinterpret_cast<const char*>(&next_[1]); }
...
template <class Comparator>
inline MyInlineSkipList<Comparator>::Iterator::Iterator(
        const MyInlineSkipList* list) {
  SetList(list);
}

template <class Comparator>
inline void MyInlineSkipList<Comparator>::Iterator::SetList(
        const MyInlineSkipList* list) {
  list_ = list;
  node_ = nullptr;
}
...
template <class Comparator>
inline bool MyInlineSkipList<Comparator>::Iterator::Valid() const {
  return node_ != nullptr;
}

template <class Comparator>
inline const char* MyInlineSkipList<Comparator>::Iterator::key() const {
  assert(Valid());
  return node_->Key();
}

template <class Comparator>
inline void MyInlineSkipList<Comparator>::Iterator::Next() {
  assert(Valid());
  node_ = node_->Next(0);
}

template <class Comparator>
inline Status MyInlineSkipList<Comparator>::Iterator::NextAndValidate(
        bool allow_data_in_errors) {
  assert(Valid());
...
template <class Comparator>
inline void MyInlineSkipList<Comparator>::Iterator::Prev() {
...
template <class Comparator>
inline Status MyInlineSkipList<Comparator>::Iterator::PrevAndValidate(
...
template <class Comparator>
inline void MyInlineSkipList<Comparator>::Iterator::Seek(const char* target) {
  node_ = list_->FindGreaterOrEqual(target, nullptr);
}

template <class Comparator>
inline Status MyInlineSkipList<Comparator>::Iterator::SeekAndValidate(
...
template <class Comparator>
inline void MyInlineSkipList<Comparator>::Iterator::SeekForPrev(
        const char* target) {
  Seek(target);
  if (!Valid()) {
    SeekToLast();
...
template <class Comparator>
inline void MyInlineSkipList<Comparator>::Iterator::RandomSeek() {
  node_ = list_->FindRandomEntry();
}

template <class Comparator>
inline void MyInlineSkipList<Comparator>::Iterator::SeekToFirst() {
  node_ = list_->head_->Next(0);
}

template <class Comparator>
inline void MyInlineSkipList<Comparator>::Iterator::SeekToLast() {
...
template <class Comparator>
int MyInlineSkipList<Comparator>::RandomHeight() {
...
template <class Comparator>
bool MyInlineSkipList<Comparator>::KeyIsAfterNode(const char* key,
                                                Node* n) const {
...
template <class Comparator>
bool MyInlineSkipList<Comparator>::KeyIsAfterNode(const DecodedKey& key,
                                                Node* n) const {
  // nullptr n is considered infinite
  assert(n != head_);
  return (n != nullptr) && (compare_(n->Key(), key) < 0);
...
template <class Comparator>
typename MyInlineSkipList<Comparator>::Node*
MyInlineSkipList<Comparator>::FindGreaterOrEqual(
...
template <class Comparator>
typename MyInlineSkipList<Comparator>::Node*
MyInlineSkipList<Comparator>::FindLessThan(const char* key,
...
template <class Comparator>
typename MyInlineSkipList<Comparator>::Node*
MyInlineSkipList<Comparator>::FindLast() const {
  Node* x = head_;
  int level = GetMaxHeight() - 1;
  while (true) {
    Node* next = x->Next(level);
...
template <class Comparator>
typename MyInlineSkipList<Comparator>::Node*
MyInlineSkipList<Comparator>::FindRandomEntry() const {
...
template <class Comparator>
uint64_t MyInlineSkipList<Comparator>::EstimateCount(const char* key) const {
  uint64_t count = 0;
...
template <class Comparator>
MyInlineSkipList<Comparator>::MyInlineSkipList(const Comparator cmp,
                                           Allocator* allocator,
                                           NvmArena* nvm_allocator,
                                           int32_t max_height,
...
template <class Comparator>
char* MyInlineSkipList<Comparator>::AllocateKey(size_t key_size) {
  return const_cast<char*>(AllocateNode(key_size, RandomHeight())->Key1());
}
template <class Comparator>
size_t MyInlineSkipList<Comparator>::NvmUsage() {
  return nvm_allocator_->MemoryUsage();
}
template <class Comparator>
typename MyInlineSkipList<Comparator>::Node*
MyInlineSkipList<Comparator>::AllocateNode(size_t key_size, int height) {
...
template <class Comparator>
typename MyInlineSkipList<Comparator>::Splice*
MyInlineSkipList<Comparator>::AllocateSplice() {
...
template <class Comparator>
typename MyInlineSkipList<Comparator>::Splice*
MyInlineSkipList<Comparator>::AllocateSpliceOnHeap() {
  size_t array_size = sizeof(Node*) * (kMaxHeight_ + 1);
...
template <class Comparator>
bool MyInlineSkipList<Comparator>::Insert(const char* key) {
  return Insert<false>(key, seq_splice_, false);
}

template <class Comparator>
bool MyInlineSkipList<Comparator>::InsertConcurrently(const char* key) {
...
template <class Comparator>
bool MyInlineSkipList<Comparator>::InsertWithHint(const char* key, void** hint) {
  assert(hint != nullptr);
...
template <class Comparator>
bool MyInlineSkipList<Comparator>::InsertWithHintConcurrently(const char* key,
                                                            void** hint) {
  assert(hint != nullptr);
  Splice* splice = reinterpret_cast<Splice*>(*hint);
  if (splice == nullptr) {
...
template <class Comparator>
template <bool prefetch_before>
void MyInlineSkipList<Comparator>::FindSpliceForLevel(const DecodedKey& key,
...
template <class Comparator>
void MyInlineSkipList<Comparator>::RecomputeSpliceLevels(const DecodedKey& key,
                                                       Splice* splice,
                                                       int recompute_level) {
...
template <class Comparator>
bool MyInlineSkipList<Comparator>::Contains(const char* key) const {
...
template <class Comparator>
void MyInlineSkipList<Comparator>::TEST_Validate() const {
...
template <class Comparator>
Status MyInlineSkipList<Comparator>::Corruption(Node* prev, Node* next,
                                              bool allow_data_in_errors) {
