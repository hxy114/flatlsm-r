...
public:
    ...
    OutputL0Iterator GetOutputs() const;
    ...
    void BuildSubcompactionJobInfo(
      ...
      const CompactionL0* c = compaction;
    ...
    SubcompactionL0State() = delete;
    SubcompactionL0State(const SubcompactionL0State&) = delete;
    SubcompactionL0State& operator=(const SubcompactionL0State&) = delete;

    SubcompactionL0State(CompactionL0* c, const std::optional<Slice> _start,
    ...
    SubcompactionL0State(SubcompactionL0State&& state) noexcept
    ...
    CompactionL0Outputs& Current() const {
...
private:
    ...
    CompactionL0Outputs compaction_outputs_;
    CompactionL0Outputs penultimate_level_outputs_;
    CompactionL0Outputs* current_outputs_ = &compaction_outputs_;
